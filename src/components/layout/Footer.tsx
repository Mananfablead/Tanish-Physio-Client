        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 mt-4">
              <a href="https://www.facebook.com/TanishPhysioFitnessandLaserClinic" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary hover:scale-110  transition-colors">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="https://www.instagram.com/tanish_physio_fitness_clinic/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary  hover:scale-110  transition-colors">
                <Instagram className="h-5 w-5" />
              </a>
              <a href="https://www.linkedin.com/in/dr-khhushbu-joshi-9b087b179/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary hover:scale-110  transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:drkhushboo26@gmail.com" className="hover:text-primary transition-colors">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="https://www.google.com/maps/search/?api=1&query=5%2C+Dhaval+Appts%2C+Besides+Telephone+Exchange%2C+Choksiwadi+Road%2C+Ajaramar+Chowk%2C+Adajan" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
