...
const VideoCall = ({
  ...
  const [showGoogleMeetPopup, setShowGoogleMeetPopup] = useState(false);
  const [generatedGoogleMeetLink, setGeneratedGoogleMeetLink] = useState(null);

  // Add notification hook
  const { reportConnectionFailure } = useNotifications();
