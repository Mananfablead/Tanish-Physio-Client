...
"
              ...
              {user?.subscriptionData ? (
                      ...
                      <div className="relative">
                        ...
                        <div className="h-12 pl-10 rounded-xl bg-slate-50 border border-slate-200 flex items-center font-bold text-slate-700">
                          {user.subscriptionData?.planId
                            ? String(user.subscriptionData.planId)
                                .charAt(0)
                                .toUpperCase() +
                      ...
                      <div className="relative">
                        ...
                        <div className="h-12 pl-10 rounded-xl bg-slate-50 border border-slate-200 flex items-center font-bold text-slate-700">
                          {user.subscriptionData?.status
                            ? String(user.subscriptionData.status)
                                .charAt(0)
                                .toUpperCase() +
                      ...
                      {!user.subscriptionData?.isExpired ? (
                        <>
                          <p className="text-3xl font-bold text-slate-900">
                            {user.subscriptionData?.daysRemaining ?? 0} Days
                            Left
                          </p>
                          <p className="text-slate-600 mt-1">
                            Your subscription is active and valid until the
                            expiry date.
                          </p>
                        </>
                      ) : (
                ...
                <div className="flex flex-col items-center justify-center py-10 text-center">
                  ...
                  <p className="text-slate-500">
                    You currently do not have an active subscription. Upgrade to
                    unlock premium features and personalized care.
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="space-y-6">
                <div className="bg-slate-50 rounded-xl p-5">
                  ...
                  <p className="text-slate-600 mb-4">
                    Your health questionnaire responses help us provide
  ...
  "
    ...
    "
                      >
                        {user?.healthProfile?.questionnaireMetadata?.responses
                          ?.length || 0}{" "}
                        responses
                      </span>
                    </div>
                  ...
                  <div className="mt-5">
                    ...
                    <div className="space-y-3 max-h-60 overflow-y-auto pr-2">
                      ...
                      {(!user?.healthProfile?.questionnaireMetadata
                        ?.responses ||
                        user.healthProfile.questionnaireMetadata.responses
                          .length === 0) && (
            ...
            <div className="space-y-6">
              ...
              {user?.purchasedServices?.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-10 text-center">
                  ...
                  <p className="text-slate-500">
                    You haven't purchased any services yet. Explore our
