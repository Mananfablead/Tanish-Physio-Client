...
const InvoicePage = () => {
  ...
  const bookingData =
    invoiceData?.bookingData || locationState?.bookingData || {};
  ...
  const isFreeConsultation =
    invoiceData?.isFreeConsultation ||
  ...
  const sessionDate =
    invoiceData?.sessionDate || bookingDetails?.date
  ...
  const isSubscription =
    invoiceData?.isSubscription || bookingData?.fromSubscription === true;
