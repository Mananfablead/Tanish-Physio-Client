      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 py-4 pb-8">
        ...
        <div className="container relative z-10 text-center space-y-4 px-4 max-w-6xl mx-auto py-8">
          ...
          <p className="text-sm md:text-base text-slate-600 mb-8 max-w-2xl mx-auto">
            Real stories from individuals who achieved better mobility and
            lasting recovery through expert physiotherapy care.
          </p>
        </div>
      </div>
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto bg-gray-50 rounded-xl p-8 border border-gray-200">
              ...
              <p className="text-gray-600">
                Check back later for patient stories.
              </p>
            </div>
          </div>
        ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              {testimonials.map((testimonial) =>
                testimonial.video ? (
                  ...
                  <Card
                    key={testimonial._id}
                    className="h-full flex flex-col border border-gray-200 shadow-sm bg-gradient-to-br from-primary/5 to-white rounded-2xl overflow-hidden transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
                  >
                    <div className="p-0">
