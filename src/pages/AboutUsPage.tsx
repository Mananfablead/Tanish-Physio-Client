              ...
              <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-20 items-center">
                ...
                {about.images && about.images.length > 0 && (
                  ...
                  >
                    ...
                    <div className="absolute -bottom-6 -right-4 sm:-bottom-8 sm:-right-6 md:-bottom-12 md:-right-6 w-2/3 sm:w-3/4 rounded-2xl overflow-hidden shadow-2xl border-4 border-white transform rotate-3 hover:rotate-0 transition-transform duration-500">
                      <img
                        src={about.images[1]}
                        alt="About Secondary"
                        className="w-full h-40 sm:h-48 md:h-56 lg:h-[320px] object-cover"
                      />
                    </div>
