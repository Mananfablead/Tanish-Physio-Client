        ...
        <div className="lg:col-span-7 flex justify-center lg:justify-start">
          <div className="w-full max-w-[520px] bg-white rounded-[2rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.08)] border border-slate-100 p-8 md:p-12 relative animate-in fade-in zoom-in-95 duration-700">
            ...
            <div className="text-center lg:text-left mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900">Reset your password</h2>
              <p className="text-slate-500 mt-2 font-medium">Enter your new password to continue</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <Form {...resetForm}>
                <form onSubmit={resetForm.handleSubmit(onSubmit)} className="space-y-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[11px] font-bold uppercase tracking-widest text-slate-500 ml-1">New Password</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[11px] font-bold uppercase tracking-widest text-slate-500 ml-1">Confirm New Password</FormLabel>
                        <FormControl>
                          <div className="relative">
                            <input
                              {...field}
              ...
              <div className="text-center mt-6">
                <p className="text-sm text-slate-600 font-medium">
                  ...
                  <Link to="/login" className="text-primary font-bold hover:text-green-700 transition-colors">
                    Sign in here
                  </Link>
                </p>
              </div>
