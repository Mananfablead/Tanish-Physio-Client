...
//       // Filter only available slots and return their start times
...
// const availabilityForSelectedDate = availability.find(
//   (a: any) => a.date === format(selectedDate, "yyyy-MM-dd")
// );

// const availableSlots =
//   availabilityForSelectedDate?.slots?.filter(
...
//         availabilityForDate?.slots?.some(
//           (slot: any) => slot.status === "available"
//         ) ?? false;

//       const isUnavailable =
//         availabilityForDate?.status === "unavailable";
...
//             if (availabilityForDate.status === "unavailable") return;

//             setSelectedDate(day);
//             setIsBookingModalOpen(true);
//           }}
//           className={`h-10 rounded-xl text-sm font-medium flex flex-col items-center justify-center transition-all relative
//             ${
//               isToday
...
//                 : availabilityForDate?.status === "available" && hasAvailableSlots
...
//   {availabilityForSelectedDate?.slots?.length > 0 ? (
//   <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2">
//     {availabilityForSelectedDate.slots.map((slot: any, index: number) => {
...
//           className={`py-2 text-xs font-bold rounded-lg ${slotStyle}`}
//           onClick={() => {
...
//     </div>
//     <h3 className="text-lg font-bold text-red-500">Not Available</h3>
